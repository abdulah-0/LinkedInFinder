...
A production-ready web application for scraping LinkedIn company data using SerpAPI and Supabase.

## Features

- **Search**: Find companies by name, location, or business type.
